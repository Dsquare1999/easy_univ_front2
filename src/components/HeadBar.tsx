...
const HeadBar = () => {
    ...
    const [name, setName] = useState<string | undefined>(session?.user?.name ? session?.user?.name : "Nom Complet");
    const [email, setEmail] = useState<string | undefined>(session?.user?.email ? session?.user?.email : "Email");
        ...
        <div className="flex-align gap-16">
            ...
            <div className="dropdown">
                <button className="users arrow-down-icon border border-gray-200 rounded-pill p-4 d-inline-block pe-40 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span className="position-relative profile-avatar">
                        <img src={profileImage} alt="Image" className="h-32 w-32 rounded-circle"/>
                    ...
                    <div className="card border border-gray-100 rounded-12 box-shadow-custom">
                        <div className="card-body">
                            <div className="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                                <img src={profileImage} alt="" className="w-54 h-54 rounded-circle" />
                                <div className="">
